...
print('loading data...')
data1 = load_csv(r'combined_attenuation', 14, "combined")
data2 = load_csv(r'combined_attenuation', 1, "combined")
data3 = load_csv(r'combined_attenuation', 2, "combined")
data4 = load_csv(r'combined_attenuation', 3, "combined")
data5 = load_csv(r'combined_attenuation', 4, "combined")
data6 = load_csv(r'combined_attenuation', 5, "combined")
data7 = load_csv(r'combined_attenuation', 6, "combined")
data8 = load_csv(r'combined_attenuation', 7, "combined")
data9 = load_csv(r'combined_attenuation', 8, "combined")
data10 = load_csv(r'combined_attenuation', 9, "combined")
data11 = load_csv(r'combined_attenuation', 10, "combined")
data12 = load_csv(r'combined_attenuation', 11, "combined")
data13 = load_csv(r'combined_attenuation', 12, "combined")
data14 = load_csv(r'combined_attenuation', 13, "combined")
data15 = load_csv(r'combined_attenuation', 0, "combined")
...
train_data, train_w, train_d, label, test_data, test_w, test_d, test_l, test_med, test_min\
	= generate_data(data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, seq_len, pre_len, pre_sens_num)
...
# conv-lstm
main_input = Input((15, 15, 1),name='main_input')
