...
train_data, train_w, train_d, label, test_data, test_w, test_d, test_l, test_med, test_min\
	= generate_data(data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, seq_len, pre_len, pre_sens_num)
...
# conv-lstm
main_input = Input((15, 12, 1),name='main_input')
